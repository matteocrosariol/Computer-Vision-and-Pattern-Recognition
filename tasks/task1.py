...
def task_1():
    ...
    #resize the images in order to feed them to the network: Anisotropic scaling
    ...
    #best result of 30% reached with a lr=0.0001 with 80 epochs
    #result of 28.9% reached with lr=0.001 with 23 (maybe better 25/28)
    ...
    for epoch in range(EPOCHS_LIMIT):
        ...
        with torch.no_grad():   # Disable gradient computation and reduce memory consumption
            ...
            if validation_loss < best_validation_loss:
                ...
                if no_improvement_counter==15: #stop validation if there are 15 epochs without improvements
                    break #exit here
    ...
    save_loss_accuracy_plot(
        ...
        training_accuracies, 
        validation_accuracies,  
        "loss_and_accuracy_task_1.png"
    )

    save_confusion_matrix(
        confusion_matrix(all_labels, all_predictions),
        test_accuracy,
        "confusion_matrix_task_1.png",
        test_dataset
    )
