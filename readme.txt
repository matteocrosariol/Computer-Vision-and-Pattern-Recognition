...
The pdf file CPVR_Crosariol_Matteo is the pdf report about the project implementation.

IMPORTANT!
In order to run the program it is needed to add the folder Dataset at the same folder deep of main.py. This folder is the datset of project assignement just renaimed as 'Dataset'.
